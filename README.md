...
The planning map opens ready to add pins. On desktop, click to place a pin, drag to pan and use the wheel or trackpad to zoom; right-click a pin to remove it. On iPhone, tap to place a pin, drag the map with one finger, pinch with two, and tap a pin for Delete. Drag a pin to move it. Open the panel to finish adding pins or review their order and route limits. Tabs support arrow-key, Home and End navigation; the panel scrolls independently and respects the phone’s bottom safe area.
