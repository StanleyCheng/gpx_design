    ...
    $('find-routes').addEventListener('click', async () => {
      ...
      $('route-options').replaceChildren(element('div', 'Checking real paths and transport connections. The search may take up to two minutes; you can cancel.', 'routes-empty')); render(false);
