...
(function (root, factory) {
  ...
  function buildGraph(data, features = [], options = {}) {
    ...
    if (!eligible.size) throw routeError('NO_ELIGIBLE_NETWORK', `No eligible walking network was found under your access and terrain settings.${roadsExcluded ? ' Your 0 km road limit excludes all mapped road connectors; use a mapped footpath or explicitly change that allowance.' : ''}`);
