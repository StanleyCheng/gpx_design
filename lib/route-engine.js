...
(function (root, factory) {
  ...
  return { MAX_WAYPOINTS, MAX_SNAP_CANDIDATES, MAX_APPROACH, TRANSPORT_EXPANSION_STEPS, distance, walkable, passableNode, buildGraph, nearest, snapWaypoints, transportStops, search, pathFrom, distinct, optimizeOrder, plan, boundingBox, queryFor, transportExpansion, coverageBox };
});
